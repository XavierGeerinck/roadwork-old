...
//         },
//         createByUserId: function (authCredentialsId) {
//             return `createByUserId_called_with_${authCredentialsId}`;
//         }
//     };
//
...
//
//             options.handler(request, (result) => {
//                 expect(result).to.equal(`createByUserId_called_with_${request.auth.credentials.get('id')}`);
//                 done();
//             });
//         });
//
